...
public class FileInfoServiceImpl implements FileInfoService {
    ...
    public void initializeMinioClient() {
        this.minioClient = MinioClient.builder()
                ...
                .credentials(appConfig.getAccessKey(), appConfig.getSecretKey())
                .build();
    }
    ...
    public void transferFile(String fileId, SessionWebUserDto webUserDto) {
        ...
        try {
            ...
            String month1 = DateUtil.format(curDate1, DateTimePatternEnum.YYYYMM.getPattern());
            String fileSuffix1 = StringTools.getFileSuffix(fileInfo.getFileName());
            // 使用流上传文件到 MinIO
            try {
                minioClient.uploadObject(
                        UploadObjectArgs.builder()
                                ...
                                .filename("F:/easypan-all/file/" + month1 + "/" + webUserDto.getUserId() + fileId + fileSuffix1)
                                .build()
                );
